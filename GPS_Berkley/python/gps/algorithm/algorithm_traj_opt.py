...
class AlgorithmTrajOpt(Algorithm):
    ...
    def iteration(self, sample_lists):
        ...
        """
        # here the sample_list is the the data that is collected for 5 iteration on the simulator.
        #self.M is the number of condition which is diclared in the algorithms section
        for m in range(self.M):
            #here the list of sample_list objects are created
        ...
        # print(self._hyperparams['inner_iterations'],'what is inner itera')

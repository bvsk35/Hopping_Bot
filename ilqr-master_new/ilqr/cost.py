...
'''
QRCost_GPS: QRCost modified for GPS
'''
class QRCost_GPS(Cost):

    """Quadratic Regulator Instantaneous Cost."""

    def __init__(self, Q, R, Q_terminal=None, x_goal=None, state_size=5, action_size=1):
        """Constructs a QRCost.

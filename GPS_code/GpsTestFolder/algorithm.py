...
class Algorithm(object):
    ...
    def __init__(self, hyperparams):
        ...
        #in the case of the parameters the agent is the
        #here the value of the T is 100
        ...
        print(config['init_traj_distr'],'config[init_traj_distr]')
        ...
        #print(self.cur.traj_distr,'agent ===')
        self.prev = [IterationData() for _ in range(self.M)]

        if self._hyperparams['fit_dynamics']:
            dynamics = self._hyperparams['dynamics']
        #this is where the trajectory information is stored
    ...
    def _update_dynamics(self):
        ...
        current samples.
        """
        #print(self.cur[0].traj_info,'checking data type of the cur')
        #here traj_info is the Trajectory info folder found in 
        for m in range(self.M):

...
extra_params['include_dirs'] = [
    ...
    '',
    '/usr/include/eigen3',
    '/home/rrl/hoppingbot/Hoppingbot/rbdl/python',
    '/home/rrl/hoppingbot/Hoppingbot/rbdl/include',
    '/home/rrl/hoppingbot/Hoppingbot/rbdl/build/include',
    '/usr/include/eigen3/'
]
...
extra_params['library_dirs'] = [
  '/home/rrl/hoppingbot/Hoppingbot/rbdl/build/python/../',
  '/usr/local/lib/',
  '/usr/lib',
  BASEDIR
  ]
